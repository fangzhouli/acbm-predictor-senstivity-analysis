...
def acbm(conc_inoc, V_inoc, V_seed, conc_seed, V_b,
    ...
    """model output function for calculating minimum price of ACBM to meet
        annual capital and operating expences"""
    ...
    # desired_n_cell_seed > desired_n_cell_inoc
    # desired_n_cell_bioreactor > desired_n_cell_seed
    # concen_desired * V_c <= 10 ** -6
    # epsilon <= 1
    desired_n_cell_bioreactor   = 1000 * V_b * concen_desired * 1000
    desired_n_cell_seed         = 1000 * V_seed * conc_seed
    desired_n_cell_inoc         = 1000 * V_inoc * conc_inoc
